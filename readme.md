...
|---|---|---|---|---|
| Freight Quotes | Allpost | `allpost:freight-quotes` | **a cada 5 min** | Roda na inicialização após ~2s. |
| Freight Orders | Allpost | `allpost:freight-orders` | **a cada 1 hora** | Roda na inicialização após ~3s. Range sobreposto (**últimos 2 dias UTC**) para capturar atualizações. |
